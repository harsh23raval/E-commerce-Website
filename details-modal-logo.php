<div class="modal fade details-1" id="details-2" tableindex="-1" role="dailog" aria-labelledby="details-1" aria-hidden="true">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="center-block">
								<img src="img/logo.png" alt="Jeans" class="details img-responsive">
							</div>
						</div>
						<div class="col-sm-6">
							<h4>Details</h4>
